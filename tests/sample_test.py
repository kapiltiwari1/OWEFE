...
# initiate the logger (from the API docs)
...
# components to these buses will be added to the energy system
...
# create fixed source.......
# object representing domestic sewage
energysystem.add(
    solph.Source(
        label="wastewater",
...
# create sink object.......
# representing the electrical demand
energysystem.add(
    solph.Sink(
        label="demand_el",
...
# object representing a gas power plant
energysystem.add(
    solph.Transformer(
        label="digester_gas",
...
# create storage object representing a battery and adding to the storage...
